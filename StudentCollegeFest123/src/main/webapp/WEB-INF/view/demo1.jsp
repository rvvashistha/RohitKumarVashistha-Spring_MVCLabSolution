...
<body class="d-flex h-100 text-center text-bg-dark"
	...
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
		<header class="mb-auto">
			<div>
				<h3 class="float-md-start mb-0">Register Now</h3>
		...
		<main class="px-3">
			...
			<p class="lead">Student interested in college debate can click here and register </p>
			<p class="lead">
				<a href="student/list"
					class="btn btn-lg btn-secondary fw-bold border-white bg-white">click here to register</a>
			</p>
		</main>

		<footer class="mt-auto text-white-50">
			<p>
				Registration page for <a href="https://getbootstrap.com/"
					class="text-white">xyz college</a>, by <a
					href="https://twitter.com/mdo" class="text-white">@xyxcollege</a>.
			</p>
		</footer>
	</div>
